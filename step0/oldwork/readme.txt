...
NOTE: This directory focuses on preliminary work with volume 1 (boesp-1_ansi.txt).
Thomas later uploaded boesp-2_ansi.txt and boesp-3_ansi.txt, but no work is
done with these, as they are superceded by boesp.all_ansi.txt.
Work with boesp.all_ansi.txt is done in directory step2.

The 'kedit' work (see notes below) was relevant for the early work with
Thomas on volume 1.
